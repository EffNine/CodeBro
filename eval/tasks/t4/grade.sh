#!/usr/bin/env bash
# T4 grader: install held-out hidden tests into a scratch copy of the fixture,
# then run the full suite plus a stdout-purity probe of the compiled binary.
# The grader decides correctness, never the transcript.
#
