...
pub struct Provenance {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub repo_identity: Option<crate::repo_state::RepoIdentity>,
    /// Repository state at production time (optional).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub repo_state: Option<crate::repo_state::RepoState>,
...
impl Provenance {
    ...
    pub fn with_repo_identity(mut self, identity: crate::repo_state::RepoIdentity) -> Self {
        self.repo_identity = Some(identity);
        self
    }

    /// Chain-setter for repo_state.
    pub fn with_repo_state(mut self, state: crate::repo_state::RepoState) -> Self {
...
impl FreshnessResolver for DefaultFreshnessResolver {
    fn resolve(
        ...
        let current = crate::repo_state::RepoState::capture(&workspace_root.to_path_buf());
...
mod tests {
    ...
    fn sample_provenance() -> Provenance {
        Provenance {
            ...
            repo_identity: Some(crate::repo_state::RepoIdentity {
    ...
    fn default_resolver_returns_unknown_without_workspace_root() {
        ...
        p.repo_state = Some(crate::repo_state::RepoState {
            commit_sha: "abc".to_string(),
            working_tree_dirty: false,
            working_tree_hash: "h1".to_string(),
        });
