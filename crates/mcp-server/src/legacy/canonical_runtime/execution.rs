...
use crate::legacy::agent::tool_parser::ToolCall;
use crate::legacy::provider_runtime::routing::ProviderRoutingDecision;
use crate::legacy::provider_runtime::{ProviderId, ProviderRuntime, RetryController, TokenUsage};
use crate::legacy::providers::{Provider,StructuredToolCall,ToolDefinition};
...
pub(crate) fn classify_response(
    ...
    let mut parsed: Vec<ToolCall> = if !structured.is_empty() {
        ...
        crate::legacy::agent::tool_parser::parse_tool_calls(full).unwrap_or_default()
    };
    ...
    for call in parsed.iter_mut() {
        call.arguments = crate::legacy::agent::tool_parser::unwrap_tool_arguments(&call.arguments);
    }
...
pub(crate) async fn stream_once(
    ...
    loop {
        ...
        provider_runtime.report_success(
            &provider_id,
            tokens,
            crate::legacy::provider_runtime::ProviderCost::default(),
        );
