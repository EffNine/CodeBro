...
impl ContextSection {
    ...
    pub fn from_source(source: &crate::legacy::assembly::ContextSource) -> ContextSection {
        match source {
            crate::legacy::assembly::ContextSource::UserRequest => ContextSection::UserIntent,
            crate::legacy::assembly::ContextSource::Workspace => ContextSection::Workspace,
            crate::legacy::assembly::ContextSource::Indexer | crate::legacy::assembly::ContextSource::Scanner => {
                ContextSection::RelevantFiles
            }
            crate::legacy::assembly::ContextSource::EngineeringFacts => ContextSection::EngineeringFacts,
            crate::legacy::assembly::ContextSource::Git => ContextSection::GitChanges,
            crate::legacy::assembly::ContextSource::Memory => ContextSection::Memory,
            crate::legacy::assembly::ContextSource::ToolResults => ContextSection::ToolResults,
        }
    }
}
...
pub fn order_fragments(fragments: &mut Vec<crate::legacy::assembly::ContextFragment>) {
...
mod tests {
    use super::*;
    use crate::legacy::assembly::{ContextFragment, ContextPriority, ContextSource};
