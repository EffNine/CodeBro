...
use crate::legacy::workspace_runtime::context::WorkspaceRoot;
use crate::legacy::workspace_runtime::discovery::DiscoveryReport;
use crate::legacy::workspace_runtime::environment::EnvironmentProfile;
use crate::legacy::workspace_runtime::repository::RepositoryFacts;
...
impl WorkspaceMetadata {
    ...
    pub fn build(
        ...
        WorkspaceMetadata {
            ...
            os: match env.os {
                crate::legacy::workspace_runtime::environment::Os::MacOs => Environment::MacOs,
                crate::legacy::workspace_runtime::environment::Os::Linux => Environment::Linux,
                crate::legacy::workspace_runtime::environment::Os::Windows => Environment::Windows,
                _ => Environment::Other,
            }
            .to_string(),
