...
use crate::legacy::workspace_runtime::context::WorkspaceContext;
use crate::legacy::workspace_runtime::filesystem::{EntryKind, FileSystem};
use crate::legacy::workspace_runtime::snapshot::{
...
impl FileWatcher {
    ...
    pub fn poll(
        ...
        max_entries: usize,
    ) -> crate::legacy::workspace_runtime::context::WorkspaceRuntimeResult<WatchBatch> {
        // Shallow scan through the abstraction.
        let listing = self.fs.list(&self.ctx, max_entries).map_err(|e| {
            crate::legacy::workspace_runtime::context::WorkspaceRuntimeError::Io(format!("{e:?}"))
        })?;
        ...
        let snapshot = WorkspaceSnapshot {
            ...
            entries: listing
                .entries
                .into_iter()
                .map(|e| crate::legacy::workspace_runtime::snapshot::SnapshotEntry {
