...
mod tests {
    ...
    fn caps(xs: &[Capability]) -> crate::legacy::provider_runtime::CapabilitySet {
        crate::legacy::provider_runtime::CapabilitySet::new(xs.iter().copied())
    }
    ...
    fn test_register_trait_object() {
        struct P {
            id: ProviderId,
            caps: crate::legacy::provider_runtime::CapabilitySet,
        }
        impl Provider for P {
            fn id(&self) -> &ProviderId {
                &self.id
            }
            fn capabilities(&self) -> &crate::legacy::provider_runtime::CapabilitySet {
                &self.caps
            }
        ...
        let p = P {
            ...
            caps: crate::legacy::provider_runtime::CapabilitySet::empty(),
        };
        let r = ProviderRegistry::new();
        r.register(&p).unwrap();
