...
use crate::legacy::planning::{PlanStep, PlanningResult};
use crate::legacy::research::ResearchResult;
use crate::legacy::testing::{TestObservation, TestingResult};
...
pub struct CodingResult {
    ...
    pub git_before: Option<crate::legacy::testing::GitStateSnapshot>,
    /// Git tracked state after coding ran.
    pub git_after: Option<crate::legacy::testing::GitStateSnapshot>,
}
...
mod tests {
    ...
    fn test_request_plan_surface_is_structured() {
        let planning = PlanningResult::failed(
            "x",
            crate::legacy::planning::PlanningTermination::Completed,
            "no-op",
        );
