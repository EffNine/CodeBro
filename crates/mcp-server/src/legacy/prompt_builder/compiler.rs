...
impl PromptCompiler {
    ...
    pub fn compile_context(
        &self,
        context: &crate::legacy::engineering_context::EngineeringContext,
    ) -> CompiledPrompt {
        ...
        let alignment_like = context.goal_alignment.map(|a| match a {
            crate::legacy::engineering_objective::GoalAlignment::Direct => {
                super::sections::GoalAlignmentLike::Direct
            }
            crate::legacy::engineering_objective::GoalAlignment::Supporting => {
                super::sections::GoalAlignmentLike::Supporting
            }
            crate::legacy::engineering_objective::GoalAlignment::WeaklyRelated => {
                super::sections::GoalAlignmentLike::WeaklyRelated
            }
            crate::legacy::engineering_objective::GoalAlignment::Unclear => {
        ...
        let mut structured_facts_list: Vec<crate::legacy::engineering_context::context::StructuredFacts> =
            Vec::new();
    ...
    fn build_section(
        ...
        structured_facts: &[crate::legacy::engineering_context::context::StructuredFacts],
    ) -> PromptSection {
        match key {
...
#[cfg(test)]
mod tests {
    use crate::engineering_memory::memory_context::{MemoryEntry, MemoryTier};
    use super::*;
    ...
    fn build_context(
        ...
        if !arch_rules.is_empty() {
            let mut constraints = crate::legacy::engineering_context::constraints::ConstraintContext::new();
    ...
    fn test_compile_context_basic() {
        ...
        let context = EngineeringContextBuilder::new()
            ...
            .workspace(
                crate::legacy::engineering_context::workspace::WorkspaceContext::new(".")
            ...
            .memory(
                crate::engineering_memory::memory_context::EngineeringMemoryContext::new()
            ...
            .constraints(
                crate::legacy::engineering_context::constraints::ConstraintContext::new().add_constraint(
    ...
    fn test_compile_includes_objective_section_when_present() {
        ...
        use crate::legacy::engineering_objective::EngineeringObjective;
