...
use crate::legacy::observability::{CorrelationId, Event, EventBus, EventType};
use crate::legacy::service_registry::registry::{RegistryError, ServiceRegistry};
use crate::legacy::service_registry::service::Service;
use crate::legacy::service_registry::types::*;
...
impl ServiceLifecycle {
    ...
    pub fn activate(
        ...
        self.registry.activate(service_id).map_err(|e| match e {
            crate::legacy::service_registry::registry::RegistryError::NotFound(id) => {
                LifecycleError::NotFound(id)
            }
            crate::legacy::service_registry::registry::RegistryError::AlreadyActivated(id) => {
