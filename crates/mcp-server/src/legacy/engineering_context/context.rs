...
use crate::legacy::engineering_objective::{EngineeringObjective, GoalAlignment};
...
mod tests {
    use super::*;
    use crate::legacy::engineering_context::builder::EngineeringContextBuilder;
    use crate::legacy::engineering_context::constraints::{ConstraintCategory, EngineeringConstraint};
    use crate::legacy::engineering_context::identity::ProjectIdentity;
