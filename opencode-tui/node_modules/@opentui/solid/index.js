    ...
    if (t === "string" || t === "number") {
      ...
      if (multi) {
        ...
        if (node && isTextNode(node)) {
          ...
          node = createDynamicTextNode(value);
...
function _createTextNode(value, decodeEntities) {
  log("Creating text node:", value);
  const id = getNextId("text-node");
  if (typeof value === "number") {
    value = value.toString();
  }
  return TextNode.fromString(decodeEntities ? decodeHTMLStrict(value) : value, {
    id
  });
}
...
function Portal(props) {
  ...
  createEffect(() => {
    ...
    onCleanup2(() => el.remove(container));
  }, undefined, {
    render: true
  });
  return marker;
...
//# debugId=FA35F720EBA7099764756E2164756E21
