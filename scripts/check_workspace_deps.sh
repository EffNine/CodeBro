...
allowed() {
    case "$1" in
        ...
        codebro-jev-shadow)        echo "codebro-core" ;;
        codebro-mcp-server)        echo "codebro-core codebro-parsers codebro-fact-store codebro-identity-runtime codebro-memory-runtime codebro-sandbox-runtime codebro-impact-engine codebro-indexer codebro-change-engine codebro-context-runtime codebro-jev-shadow" ;;
        *)                         echo "" ;;
    esac
}
