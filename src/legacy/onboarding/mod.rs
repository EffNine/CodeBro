...
use crate::legacy::capability_discovery::{CapabilityDiscovery, CapabilityScanner};
use crate::legacy::provider_manager::{ProviderId, WizardState};
use crate::legacy::workspace_discovery::{DiscoveryEngine, WorkspaceDiscovery};
