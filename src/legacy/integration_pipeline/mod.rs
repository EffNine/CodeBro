...
use crate::legacy::preference_engine::{PreferenceSet, PreferenceStore};
use crate::legacy::recommendation_engine::{
    RecommendationContext, RecommendationEngine, RecommendationSet,
};
use crate::legacy::workflow_engine::{WorkflowDiagnostics, WorkflowPlan, WorkflowPlanner, WorkflowResult};
...
impl IntegrationPipeline {
    ...
    pub fn run(
        ...
        validation_config: &crate::legacy::adaptive_validation::ValidationConfig,
    ) -> PipelineResult {
        ...
        let validation_engine = crate::legacy::adaptive_validation::AdaptiveValidationEngine::new();
        let validation_diag = crate::legacy::adaptive_validation::AdaptiveDiagnostics::new(100);
...
mod tests {
    use super::*;
    use crate::legacy::intent_engine::IntentType;
    use crate::legacy::preference_engine::{PreferenceOrigin, PreferenceValue};
    use crate::legacy::workflow_engine::ExecutionStrategy;

    fn make_test_preferences() -> PreferenceSet {
        let mut set = PreferenceSet::new();
        set.add(crate::legacy::preference_engine::Preference::new(
            "model",
            crate::legacy::preference_engine::PreferenceCategory::Model,
        ...
        set.add(crate::legacy::preference_engine::Preference::new(
            "provider",
            crate::legacy::preference_engine::PreferenceCategory::Provider,
    ...
    fn test_pipeline_preference_change() {
        ...
        let config = crate::legacy::adaptive_validation::ValidationConfig::new();
        ...
        assert_eq!(
            ...
            crate::legacy::adaptive_validation::ValidationResult::Pass
        );
