...
use crate::legacy::adaptive_validation::{ValidationReport, ValidationResult};
use crate::legacy::intent_engine::{
    AmbiguityResult, ConfidenceResult, IntentPlan, IntentType, ResolvedCommand,
};
use crate::legacy::recommendation_engine::RecommendationSet;
use crate::legacy::workflow_engine::WorkflowResult;
...
pub struct PipelineResult {
    ...
    pub previews: Vec<crate::legacy::intent_engine::ApprovalPreview>,
...
impl PipelineResult {
    pub fn new(
        ...
        previews: Vec<crate::legacy::intent_engine::ApprovalPreview>,
    ...
    pub fn is_approval_ready(&self) -> bool {
        !self.ambiguity_result.is_ambiguous
            ...
            && !self.workflow_result.plan.issues.iter().any(|i| matches!(i, crate::legacy::workflow_engine::WorkflowIssue::DependencyCycle { .. }))
...
mod tests {
    ...
    fn test_pipeline_result_creation() {
        ...
        let result = PipelineResult::new(
            ...
            WorkflowResult::new(
                crate::legacy::workflow_engine::WorkflowPlan::new(
                    "plan-1".to_string(),
                    "test-1",
                    vec![],
                    vec![],
                    crate::legacy::workflow_engine::ExecutionStrategy::Sequential,
                    vec![],
                    vec![],
                ),
                crate::legacy::workflow_engine::WorkflowMetadata::default(),
            ),
