...
use crate::legacy::provider_runtime::capabilities::CapabilitySet;
use crate::legacy::provider_runtime::types::{Priority, ProviderCost, ProviderId};
use crate::legacy::provider_runtime::Provider as RuntimeProvider;

/// A descriptive provider view over an I/O provider plugin.
pub struct ProviderAdapter {
    provider: Arc<dyn crate::legacy::providers::Provider>,
    id: ProviderId,
...
impl ProviderAdapter {
    ...
    pub fn new(provider: Arc<dyn crate::legacy::providers::Provider>) -> Self {
    ...
    pub fn io(&self) -> &Arc<dyn crate::legacy::providers::Provider> {
        &self.provider
    }
}
...
mod tests {
    use super::*;
    use crate::legacy::provider_runtime::Capability;
    ...
    impl crate::legacy::providers::Provider for DeclarativeProvider {
        fn name(&self) -> &str {
            "declarative"
        }
    ...
    impl crate::legacy::providers::Provider for PlainProvider {
        fn name(&self) -> &str {
            "plain"
        }
        fn base_url(&self) -> &str {
