...
impl From<crate::legacy::research::ResearchResult> for ResearchDiagnostics {
    fn from(result: crate::legacy::research::ResearchResult) -> Self {
        ResearchDiagnostics {
...
impl From<crate::legacy::testing::TestingResult> for TestingDiagnostics {
    fn from(result: crate::legacy::testing::TestingResult) -> Self {
...
impl From<crate::legacy::planning::PlanningResult> for PlanningDiagnostics {
    fn from(result: crate::legacy::planning::PlanningResult) -> Self {
        PlanningDiagnostics {
            completed: result.termination.is_completed(),
            synthesis_complete: result.synthesis_complete,
            termination: result.termination.to_string(),
...
impl From<crate::legacy::coding_contract::CodingResult> for CodingDiagnostics {
    fn from(result: crate::legacy::coding_contract::CodingResult) -> Self {
        CodingDiagnostics {
            completed: result.termination.is_completed(),
            synthesis_complete: result.synthesis_complete,
            termination: result.termination.to_string(),
...
impl From<crate::legacy::review::ReviewResult> for ReviewDiagnostics {
    fn from(result: crate::legacy::review::ReviewResult) -> Self {
        ReviewDiagnostics {
            completed: result.termination.is_completed(),
            synthesis_complete: result.synthesis_complete,
            termination: result.termination.to_string(),
