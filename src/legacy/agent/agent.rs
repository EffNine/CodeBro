...
use crate::legacy::agent::SkillManager;
...
#[deprecated(note = "Superseded by crate::legacy::tools::run_tool_pipeline + call_ai_streaming")]
pub struct Agent {
    pub config: Config,
    ...
    pub workspace_manager: Option<crate::legacy::agent::workspace::WorkspaceManager>,
    pub permission_manager: Option<crate::legacy::agent::permissions::PermissionManager>,
...
impl Agent {
    pub fn new(config: Config, provider: Box<dyn Provider>) -> Result<Self> {
        ...
        tools.insert(
            ...
            Box::new(crate::legacy::tools::ListFiles) as Box<dyn Tool>,
        );
        tools.insert(
            "read_file".to_string(),
            Box::new(crate::legacy::tools::ReadFile) as Box<dyn Tool>,
        );
        tools.insert(
            "create_file".to_string(),
            Box::new(crate::legacy::tools::CreateFile) as Box<dyn Tool>,
        );
        tools.insert(
            "edit_file".to_string(),
            Box::new(crate::legacy::tools::EditFile) as Box<dyn Tool>,
        );
        tools.insert(
        ...
        tools.insert(
            ...
            Box::new(crate::legacy::tools::GitStatus) as Box<dyn Tool>,
        );
        tools.insert(
            "git_diff".to_string(),
            Box::new(crate::legacy::tools::GitDiff) as Box<dyn Tool>,
        );
        ...
        let workspace_manager = Some(crate::legacy::agent::workspace::WorkspaceManager::new(
            config_dir.join("workspace.json"),
        )?);

        let permission_manager = Some(crate::legacy::agent::permissions::PermissionManager::new(
            config_dir,
        )?);
