...
use crate::legacy::agent::memory::MemoryEntry;
...
impl MemoryConsolidationEngine {
    ...
    pub fn consolidate(&self, memory: &mut crate::legacy::agent::memory::Memory) -> Vec<String> {
    ...
    fn remove_duplicates(&self, memory: &mut crate::legacy::agent::memory::Memory) {
    ...
    pub fn merge_similar(&self, memory: &mut crate::legacy::agent::memory::Memory) {
    ...
    pub fn remove_outdated(&self, memory: &mut crate::legacy::agent::memory::Memory) {
        memory.short_term.retain(|entry| !entry.is_outdated(90));
    }

    pub fn remove_low_value(&self, memory: &mut crate::legacy::agent::memory::Memory) {
...
mod tests {
    ...
    fn test_remove_duplicates() {
        let mut memory = crate::legacy::agent::memory::Memory::default();
