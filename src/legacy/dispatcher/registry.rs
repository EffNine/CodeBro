...
use crate::legacy::tools::diagnostics::DiagnosticCollector;
use crate::legacy::tools::hooks::{HookManager, PermissionDecision};
use crate::legacy::tools::lifecycle::{LifecycleManager, ToolLifecycleState};
use crate::legacy::tools::metadata::ToolMetadata;
use crate::legacy::tools::provider::ProviderRegistry;
...
impl ToolRegistry {
    ...
    pub fn register_definition(
        mut self,
        definition: crate::legacy::tools::metadata::ToolDefinition,
    ) -> Self {
    ...
    pub fn add_provider(&mut self, provider: Arc<dyn crate::legacy::tools::provider::ToolProvider>) {
    ...
    pub fn set_hooks(
        &mut self,
        name: &str,
        permission: Box<dyn crate::legacy::tools::hooks::PermissionHook>,
        rollback: Box<dyn crate::legacy::tools::hooks::RollbackHook>,
    ) {
        let hooks = crate::legacy::tools::hooks::ToolHooks::new()
    ...
    pub fn set_global_permission_hook(
        &mut self,
        hook: Box<dyn crate::legacy::tools::hooks::PermissionHook>,
    ) {
        self.hooks.set_global_permission(hook);
    }

    /// Set a global rollback hook.
    pub fn set_global_rollback_hook(&mut self, hook: Box<dyn crate::legacy::tools::hooks::RollbackHook>) {
    ...
    pub fn get_diagnostics(
        &self,
        name: &str,
    ) -> Option<crate::legacy::tools::diagnostics::ToolDiagnostics> {
        self.diagnostics.get(name)
    }

    /// Get all diagnostics.
    pub fn all_diagnostics(&self) -> Vec<crate::legacy::tools::diagnostics::ToolDiagnostics> {
    ...
    /// Get all providers.
    pub fn providers(&self) -> &[Arc<dyn crate::legacy::tools::provider::ToolProvider>] {
        self.providers.providers()
    }

    /// Get provider health status.
    pub fn provider_health(&self) -> Vec<(&str, crate::legacy::tools::diagnostics::ToolHealth)> {
    ...
    pub fn tool_definitions(&self) -> Vec<crate::legacy::providers::ToolDefinitionReexport> {
        self.names()
            .iter()
            .filter_map(|name| {
                ...
                Some(crate::legacy::providers::ToolDefinitionReexport {
