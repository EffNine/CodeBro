...
use super::rules;
use super::types::*;
use crate::legacy::intent_engine::IntentPlan;
...
mod rules_ext {
    ...
    pub fn generate_from_commands(
        command: &crate::legacy::intent_engine::IntentCommand,
        intent_id: &str,
        context: &RecommendationContext,
    ) -> Vec<Recommendation> {
        ...
        match command {
            crate::legacy::intent_engine::IntentCommand::ExecuteCommand { command, reason } => {
            ...
            crate::legacy::intent_engine::IntentCommand::UpdateModelPreference { new_value, .. } => {
            ...
            crate::legacy::intent_engine::IntentCommand::UpdateApprovalPreference { new_value, .. } => {
                if *new_value {
                    recs.push(Recommendation::new(
                        RecommendationType::General,
    ...
    pub fn generate_from_intent_type(
        intent_type: &crate::legacy::intent_engine::IntentType,
        intent_id: &str,
        context: &RecommendationContext,
    ) -> Vec<Recommendation> {
        let mut recs = Vec::new();
        ...
        match intent_type {
            crate::legacy::intent_engine::IntentType::Preference => {
                recs.push(Recommendation::new(
                    RecommendationType::General,
            ...
            crate::legacy::intent_engine::IntentType::Execution => {
                recs.push(Recommendation::new(
                    RecommendationType::General,
                    "Execution Preview",
            ...
            crate::legacy::intent_engine::IntentType::Workflow => {
                recs.push(Recommendation::new(
                    RecommendationType::Workflow,
            ...
            crate::legacy::intent_engine::IntentType::Question => {
                recs.push(Recommendation::new(
                    RecommendationType::General,
            ...
            crate::legacy::intent_engine::IntentType::Help => {
                recs.push(Recommendation::new(
                    RecommendationType::General,
                    "Quick Reference",
...
mod tests {
    ...
    fn test_engine_empty_plan() {
        ...
        let plan = IntentPlan::new(
            ...
            crate::legacy::intent_engine::IntentType::Unknown,
            "unknown",
            false,
            0.0,
            0.1,
    ...
    fn test_engine_dark_theme() {
        ...
        let plan = IntentPlan::new(
            "test-3".to_string(),
            "Enable dark theme",
            crate::legacy::intent_engine::IntentType::Configuration,
            "configuration",
            false,
            0.0,
            0.8,
