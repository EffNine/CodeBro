...
use crate::legacy::planning::contract::PlanningTermination;
use crate::legacy::planning::permissions::PlanningPermissionHook;
use crate::legacy::planning::permissions::PlanningTooling;
use crate::legacy::planning::{PlanningLimits, PlanningRequest, PlanningResult, PlanningSubagent};
...
use crate::legacy::research::ResearchResult;
use crate::legacy::testing::{TestCommandResult, TestingResult};
...
impl Provider for PlanningMockProvider {
    ...
    fn stream_response_with_tools(
        &self,
        message: &str,
        _tools: &[crate::legacy::providers::ToolDefinitionReexport],
    ) -> std::pin::Pin<
        Box<
            dyn std::future::Future<
...
fn research_result() -> ResearchResult {
    ResearchResult {
        ...
        iterations: 1,
        model_calls: 2,
        termination: crate::legacy::research::ResearchTermination::Completed,
...
fn testing_result() -> TestingResult {
    TestingResult {
        ...
        iterations: 1,
        model_calls: 2,
        termination: crate::legacy::testing::TestingTermination::Completed,
        synthesis_complete: true,
...
async fn test_planning_emits_distinguishable_events() {
    ...
    assert!(
        evs.iter().any(|e| matches!(e, AgentEvent::AgentStatusChanged { agent, status: crate::legacy::agent::status::AgentStatus::Planning } if agent == "planning")),
