...
mod tests {
    use super::*;
    use crate::legacy::provider_runtime::provider::RegisteredProvider;
    use crate::legacy::provider_runtime::types::{Priority, ProviderCost};
    ...
    fn test_discovery_healthy_only_skips_cooldown() {
        ...
        for i in 0..3 {
            hm.report_failure(
                &crate::legacy::provider_runtime::types::ProviderId::new("bad"),
