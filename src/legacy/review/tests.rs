...
use crate::legacy::canonical_runtime::ProviderAdapter;
...
async fn test_review_cannot_claim_verified_when_unverified() {
    ...
    let coding = crate::legacy::coding_contract::CodingResult {
        summary: "changed lib".to_string(),
        changes: vec![crate::legacy::coding_contract::AppliedChange {
        ...
        model_calls: 0,
        revisions: 0,
        termination: crate::legacy::coding_contract::CodingTermination::Completed,
    ...
    assert_ne!(
        result.verdict,
        crate::legacy::review::contract::ReviewVerdict::Pass,
...
async fn test_review_surfaces_verification_unavailable() {
    ...
    let coding = crate::legacy::coding_contract::CodingResult {
        ...
        model_calls: 0,
        revisions: 0,
        termination: crate::legacy::coding_contract::CodingTermination::VerificationUnavailable,
        synthesis_complete: true,
        observations: Vec::new(),
        limitations: vec![
...
async fn test_review_detects_plan_deviation() {
    ...
    let coding = crate::legacy::coding_contract::CodingResult {
        ...
        unplanned_changes: vec![crate::legacy::coding_contract::AppliedChange {
        ...
        verification: vec![crate::legacy::coding_contract::VerificationRecord {
            ...
            denied: false,
            denied_reason: None,
            source: crate::legacy::coding_contract::VerificationSource::CompletionGate,
        }],
        files_inspected: Vec::new(),
        tool_calls: 0,
        iterations: 0,
    ...
    let planning = crate::legacy::planning::PlanningResult {
        summary: "modify lib only".to_string(),
        plan: vec![crate::legacy::planning::PlanStep {
            order: 1,
        ...
        iterations: 0,
        model_calls: 0,
        termination: crate::legacy::planning::PlanningTermination::Completed,
        synthesis_complete: true,
...
async fn test_review_permission_boundary_impenetrable() {
    ...
    tooling = tooling.register(std::sync::Arc::new(crate::legacy::tools::CreateFile));
...
async fn test_review_synthesis_produces_structured_verdict() {
    ...
    assert_eq!(
        result.verdict,
        crate::legacy::review::contract::ReviewVerdict::Fail,
...
"#
    ...
    assert_eq!(result.verdict, crate::legacy::review::contract::ReviewVerdict::Fail);
    assert!(
    ...
    assert_eq!(
        ...
        crate::legacy::review::contract::ReviewSeverity::Critical
    );
    assert_eq!(
