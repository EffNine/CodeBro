...
use crate::legacy::workspace_runtime::{Change, WorkspaceRuntime};
...
pub mod budget {
    ...
    use crate::legacy::assembly::sources::ContextFragment;
...
mod tests {
    use super::*;
    use crate::legacy::assembly::sources::ContextFragment;
    use crate::legacy::assembly::sources::ContextPriority;
