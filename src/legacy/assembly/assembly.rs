...
use crate::legacy::assembly::ContextFragment;
use crate::legacy::assembly::ContextPriority;
use crate::legacy::assembly::ContextSource;
use crate::error::Result;
use crate::intelligence::CodeIndexer;
use crate::memory_runtime::MemoryRuntime;
use crate::legacy::workspace_runtime::WorkspaceRuntime;
...
pub struct ContextAssemblyRequest {
    ...
    pub project_info: Option<crate::legacy::scanner::ProjectInfo>,
...
impl ContextAssemblyRequest {
    ...
    pub fn with_project_info(mut self, info: crate::legacy::scanner::ProjectInfo) -> Self {
...
mod tests {
    use super::*;
    use crate::legacy::assembly::sources::ContextSource;
    use crate::legacy::assembly::ContextPriority;
    ...
    fn test_assemble_basic_request() {
        let ws = WorkspaceRuntime::new(
            PathBuf::from("."),
            Arc::new(crate::legacy::workspace_runtime::LocalFileSystem::new()),
        );
