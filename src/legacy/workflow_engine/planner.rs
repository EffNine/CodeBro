...
impl WorkflowPlanner {
    ...
    fn generate_steps_from_commands(&self, plan: &IntentPlan) -> Vec<WorkflowStep> {
        ...
        for (i, cmd) in plan.required_commands.iter().enumerate() {
            let step = match cmd {
                crate::legacy::intent_engine::IntentCommand::UpdateModelPreference {
                    key,
                    new_value,
                    reason,
                } => WorkflowStep::new(
                ...
                crate::legacy::intent_engine::IntentCommand::UpdateLanguagePreference {
                    key,
                    new_value,
                    reason,
                } => WorkflowStep::new(
                ...
                crate::legacy::intent_engine::IntentCommand::UpdateCostPreference {
                    key,
                    new_value,
                    reason,
                } => WorkflowStep::new(
                ...
                crate::legacy::intent_engine::IntentCommand::UpdateApprovalPreference {
                    key,
                    new_value,
                    reason,
                } => WorkflowStep::new(
                ...
                crate::legacy::intent_engine::IntentCommand::ExecuteWorkflow {
                    workflow_id,
                    reason,
                } => WorkflowStep::new(
                ...
                crate::legacy::intent_engine::IntentCommand::AnswerQuestion { .. }
                | crate::legacy::intent_engine::IntentCommand::ProvideHelp { .. } => {
